...
public class ApiClient {
    ...
    private final String API_BASE_URL = "http://chessapi:8080/api/games";
    ...
    public String testApi() {
        String url = "http://chessapi:8080/api/games/test";
    ...
    public GameResponse offerDraw(String gameId, Long playerId) {
        String url = "http://chessapi:8080/api/games/" + gameId + "/draw/offer?playerId=" + playerId;
    ...
    public GameResponse respondToDraw(String gameId, Long playerId, boolean accept) {
        String url = "http://chessapi:8080/api/games/" + gameId +
